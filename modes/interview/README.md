...
A set of reusable skills for end-to-end interview preparation.
...
| Skill | File | When to use |
|---|---|---|
| Company Research | `../interview-prep.md` | Research a specific company and role before interviewing |

## File Conventions

These skills assume the following files exist (frontrunner defaults):
