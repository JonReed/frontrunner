# frontrunner -- Danske modes (`modes/da/`)

Denne mappe indeholder de danske oversættelser af de vigtigste frontrunner-modes for kandidater, der søger på det danske marked.
