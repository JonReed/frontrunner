...
3. НАЙТИ        → Совпадение с существующими отчётами в workspace/reports/evaluations/
...
2. Искать в `workspace/reports/evaluations/` по названию компании (Grep, case-insensitive)
...
1. Обновить статус на "Applied" через канонический CLI: `node src/tracker/set-status.mjs <report#> Applied` (не редактировать таблицу `workspace/applications/tracker.md` вручную)
2. Обновить секцию G отчёта финальными ответами
3. Предложить: `/frontrunner contacto` для LinkedIn outreach
