...
1. Обновить статус на "Applied" через канонический CLI: `node src/tracker/set-status.mjs <report#> Applied` (не редактировать таблицу `data/applications.md` вручную)
