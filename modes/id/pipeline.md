# Mode: pipeline — canonical backend (Indonesian market)
...
Apply Indonesian-market vocabulary and rules from `modes/id/_shared.md` and the
selected Indonesian evaluation mode. Human-facing output still follows
