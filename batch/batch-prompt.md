# frontrunner Batch Worker — Complete Evaluation + PDF + Tracker Line
...
- Skip PDF generation.
- In the report header, write a localized equivalent of `**PDF:** not generated — run /frontrunner pdf {company-slug} to create on demand` in `language.output`.
