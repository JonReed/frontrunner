...
// modes are not edited — this lives entirely behind `node src/plugins/plugins.mjs run notion`.
//
...
//
//   node src/plugins/plugins.mjs run notion export            # mirror tracker → Notion
//   node src/plugins/plugins.mjs run notion search "platform" # read matching records → pipeline
