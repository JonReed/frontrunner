...
node src/plugins/plugins.mjs run gmail                       # ingest
node src/plugins/plugins.mjs run notion search "platform"    # search
node src/plugins/plugins.mjs run notion export [--dry-run]   # export
```
