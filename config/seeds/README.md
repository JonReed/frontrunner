...
node src/scan/scan-ats-full.mjs --seeds yc --since 7

# Seed from both YC and a16z, dry-run preview
node src/scan/scan-ats-full.mjs --seeds yc,a16z --dry-run

# Combine seeds + regular ATS sources
node src/scan/scan-ats-full.mjs --seeds yc --ats greenhouse,lever --since 5
