# Frontrunner on the Free Tier (Antigravity CLI)

frontrunner works with **Antigravity CLI's free tier** — no API key or paid
...
a rate-limit error; frontrunner will pause and suggest retrying tomorrow.
...
|-------------------------|-----------|----------------------------------|
| Offer evaluation (A-G)  | ✅        | Full scoring + legitimacy pipeline |
