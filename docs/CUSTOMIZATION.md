...
To customize templates/fonts/colors, edit the CSS in the template. Update font files in `templates/fonts/` if switching fonts.
...
2. `src/tracker/normalize-statuses.mjs` (alias mappings)
