...
const CHAT_KEY = "frontrunner:chat";
...
const GREETING =
  "Hi — I'm your frontrunner assistant. I can walk you through onboarding, answer questions about your pipeline, or take you where you need to go. What would you like to do?";
...
export function AssistantConsole() {
  ...
  const suggestions = useMemo(() => {
    ...
    if (!pipeline.applications.length && !pending.length) {
      return [
        { label: "Help me get set up", send: "Help me get started with frontrunner — what do you need from me?" },
