...
const STORAGE_KEY = "frontrunner:config";
        ...
        {mode === "cli" && (
          <div>
            <p className="mb-1 text-sm text-muted">
              frontrunner uses an AI tool you already have — signed in, your own usage, nothing to paste.
            </p>
            ...
            {clis === null ? (
              ...
              <div className="rounded-xl border border-dashed border-border bg-surface/30 p-4 text-sm text-muted">
                ...
                <a href="https://github.com/Furls-Digital/frontrunner/blob/main/docs/FREE_TIER.md" target="_blank" rel="noreferrer" className="inline-flex items-center gap-0.5 text-brand hover:underline">
