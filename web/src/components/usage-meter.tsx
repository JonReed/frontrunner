...
// Soft budgets (tunable via localStorage `frontrunner:usage-budget`). The bar
...
export function UsageMeter() {
  ...
  useEffect(() => {
    try {
      const cfg = localStorage.getItem("frontrunner:config");
      setCli(cfg ? JSON.parse(cfg).cliId || null : null);
      const b = localStorage.getItem("frontrunner:usage-budget");
