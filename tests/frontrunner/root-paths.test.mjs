...
// against the flat layout. Every selective upstream source review can
// therefore reintroduce `join(ROOT, 'scan.mjs')` or `node scan.mjs`.
//
...
//
// This test makes that mechanical. When it fails after a port, the fix is:
//
