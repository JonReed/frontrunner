...
// Sections 44-44e covered the OpenRouter/OpenAI/Gemini/Ollama evaluators.
// Frontrunner ships Claude support only (AGENTS.md), and those modules were
// removed with it. Claude's own prompt-cache boundary is asserted in
// tests/frontrunner/token-efficiency.test.mjs.
