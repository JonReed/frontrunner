...
import { loadSeenCompanyRoles, companyRoleDedupKey } from '../src/scan/scan.mjs';
...
`);
    ...
    const scan = () => execFileSync(NODE, [join(ROOT, 'src/scan/scan.mjs')], {
      cwd: dir,
      env: { ...process.env, FRONTRUNNER_PORTALS: portals },
      encoding: 'utf-8',
