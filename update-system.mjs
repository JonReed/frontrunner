...
const SYSTEM_PATHS = [
  ...
  'modes/_custom.efficiency.template.md',
  'modes/oferta.md',
  'modes/pdf.md',
  'modes/cover.md',
  'modes/email.md',
  ...
  'src/cv/generate-latex.mjs',
  'src/cv/extract-latex-content.mjs',
  'src/cv/patch-latex-content.mjs',
  'src/cv/latex-escape.mjs',
  'src/cv/latex-content.mjs',
  'src/lib/context-budget.mjs',
  'tests/context-budget-tests.mjs',
  'src/lib/golden-budget-analysis.mjs',
  'src/cv/img-to-pdf.mjs',
  'src/scan/archive-posting.mjs',
  'src/evaluate/application-answers.mjs',
  ...
  'find.mjs',
  'src/tracker/find.mjs',
  'src/tracker/verify-pipeline.mjs',
  'src/tracker/reconcile-pipeline.mjs',
  'src/tracker/pipeline-reconciliation-write.mjs',
  ...
  'src/tracker/set-status.mjs',
  'src/tracker/status-log.mjs',
  'tests/set-status-tests.mjs',
  'src/tracker/normalize-statuses.mjs',
  'src/cv/cv-sync-check.mjs',
  'src/cv/verify-cv-facts.mjs',
  'update-system.mjs',
  'src/tracker/reserve-report-num.mjs',
  'src/scan/scan.mjs',
  'src/scan/scan-all.mjs',
  ...
  'tests/frontrunner/no-application-plugins.test.mjs',
  'tests/frontrunner/openrouter-boundary.test.mjs',
  'tests/frontrunner/pdf-render-security.test.mjs',
  'tests/frontrunner/pipeline-run-lease.test.mjs',
  'tests/frontrunner/tailoring-contract.test.mjs',
  'tests/frontrunner/ui-loopback-boundary.test.mjs',
  'tests/fixtures/jd-cache-worker.mjs',
  'tests/fixtures/model-blacklist-worker.mjs',
  'tests/fixtures/pipeline-run-worker.mjs',
  'src/lib/root-paths.mjs',
  'src/analysis/classify-tier.mjs',
  'src/scan/scan-ats-full.mjs',
  'src/evaluate/match-star.mjs',
  'src/analysis/jd-skill-gap.mjs',
  'src/evaluate/prepare-application.mjs',
  'providers/',
  'config/seeds/',
  'tests/',
  'doctor.mjs',
  'src/application/doctor.mjs',
  'src/scan/check-liveness.mjs',
  'src/scan/liveness-core.mjs',
  'src/scan/liveness-api.mjs',
  'src/scan/liveness-browser.mjs',
  'src/scan/liveness-service.mjs',
  'src/evaluate/evaluation-gate.mjs',
  'src/evaluate/scoring-contract.mjs',
  'src/evaluate/execution-result.mjs',
  'src/evaluate/claude-eval.mjs',
  'src/evaluate/save-evaluation.mjs',
  'src/evaluate/evaluation-publication.mjs',
  'src/cv/claude-tailor.mjs',
  'src/cv/tailoring-contract.mjs',
  'src/cv/claude-cover.mjs',
  'src/cv/cover-contract.mjs',
  'src/cv/claude-companies.mjs',
  'src/cv/company-contract.mjs',
  ...
  'src/scan/company-history.mjs',
  'src/scan/company-history.test.mjs',
  'src/analysis/salary-gap.mjs',
  ...
  'tests/invite-match-tests.mjs',
  'src/tracker/agent-inbox.mjs',
  'src/tracker/followup-seed.mjs',
  'src/tracker/followup-store.mjs',
  'src/tracker/followup-log.mjs',
  'tests/followup-seed-tests.mjs',
  'src/lib/profile-language.mjs',
  'src/evaluate/gemini-eval.mjs',
  'src/evaluate/ollama-eval.mjs',
  'src/evaluate/openai-eval.mjs',
  'src/evaluate/openai-tailor.mjs',
  'src/evaluate/openrouter-client.mjs',
  'src/evaluate/model-blacklist.mjs',
  'src/evaluate/eval-golden.mjs',
  'tests/evals/',
  'src/evaluate/openrouter-runner.mjs',
  'test-all.mjs',
  'src/analysis/detect-reposts.test.mjs',
  'tests/salary-filter-tests.mjs',
  'tests/trust-validator-tests.mjs',
  'tests/tracker-columns-tests.mjs',
  'tests/tracker-writer-lock-tests.mjs',
  'tests/agent-inbox-tests.mjs',
  'src/scan/validate-portals.mjs',
  'src/scan/verify-portals.mjs',
  'src/scan/fix-slugs.mjs',
  'tests/updater-migration-tests.mjs',
  'validate-system-paths-coverage.mjs',
  'src/tracker/reply-matcher.mjs',
  'tests/reply-matcher.test.mjs',
  'src/tracker/reply-watch.mjs',
  'src/tracker/paste-reply.mjs',
  'tests/paste-reply-tests.mjs',
  'batch/batch-prompt.md',
  'batch/batch-runner.sh',
  'batch/aggregate-tokens.mjs',
  'batch/README.md',
  'src/lib/token-tracker.mjs',
  'src/evaluate/batch-tailor.mjs',
  'templates/',
