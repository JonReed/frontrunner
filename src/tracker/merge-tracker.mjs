...
// FRONTRUNNER_BATCH_STATE overrides the batch-state.tsv path (used by tests).
const BATCH_STATE_FILE = process.env.FRONTRUNNER_BATCH_STATE
  ? process.env.FRONTRUNNER_BATCH_STATE
  : join(FRONTRUNNER, 'workspace', '.state', 'batch-state.tsv');
