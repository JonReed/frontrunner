 ...
 *   FRONTRUNNER_TRACKER                     tracker path
 *   FRONTRUNNER_FOLLOWUPS                   follow-ups path
 *   FRONTRUNNER_PROFILE                     profile.yml path (cadence overrides)
 *   FRONTRUNNER_FOLLOWUPS_LOCK              lock directory override
 *   FRONTRUNNER_FOLLOWUPS_LOCK_TIMEOUT_MS   lock acquire timeout
 *   FRONTRUNNER_FOLLOWUPS_LOCK_RETRY_MS     lock retry interval
