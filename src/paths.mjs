...
export const INTERVIEW_SESSIONS_DIR = join(INTERVIEW_PREP_DIR, 'sessions');
export const INTERVIEW_QUESTION_BANK_FILE = join(INTERVIEW_PREP_DIR, 'question-bank.md');
