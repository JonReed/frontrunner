...
export function collectSeenCompanyRoles(sources = {}, policy = {}, canonicalize = defaultCompanyNormalizer) {
  ...
  // applications.md — header-aware parse (src/tracker/tracker-parse.mjs, #954). The old
...
// in modes/pipeline.md and expected by /frontrunner pipeline.
...
async function main() {
  ...
  if (skipTiers.length > 0) {
    const mod = await import('../analysis/classify-tier.mjs');
