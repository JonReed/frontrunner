 ...
 * or outside the frontrunner repository.
 *
...
async function generatePDF() {
  ...
  if (!inputPath || !outputPath) {
    ...
    console.error('mechanical markdown-to-HTML step by design. Run `/frontrunner pdf` in your AI');
